...
const Sidebar: FC<Props> = ({ onAddNote }) => {
  return (
      ...
      <div className="flex flex-col md:w-62">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white border-r border-gray-50">
          <div className="flex flex-row justify-between items-center flex-shrink-0 px-4">
            ...
            <div className="px-4">
              <button
                className="px-5 py-2 lg:px-3 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-slate-700 lg:px-10 rounded-md hover:bg-slate-950"
                onClick={onAddNote}
              >
                追加
              </button>
                ...
                <li className="flex flex-col p-4 mt-2 text-base transition duration-500 cursor-pointer ease-in-out transform rounded-lg bg-gray-50 focus:shadow-outline focus:shadow-outline hover:bg-gray-100">
                  <div className="flex justify-between">
                    ...
                    <div className="pl-4 flex-shrink-0">
                      <button className="px-5 py-2 lg:px-3 text-base font-medium text-center text-slate-700 transition duration-500 ease-in-out transform bg-white border border-slate-700 lg:px-10 rounded-md hover:bg-slate-700 hover:text-white">
                        削除
                      </button>
                    </div>
                  </div>
